    ...
    <main id="top">
      ...
      <header className="nav">
        ...
        <nav aria-label="Main navigation">
          <a href="#top">Home</a>
          <a href="/product">Devices</a><a href="/lab">AI Lab</a><a href="/download">Download</a><a href="/solution/">Solution</a><a href="/contact">Contact</a>
        </nav>
      ...
      <section className="source-products">
        ...
        <div className="section-title portfolio-title"><h2>从芯片到平台，<br />全栈优化医疗 AI。</h2><p>覆盖诊断全流程的智能平台与为医疗场景深度优化的处理器。</p></div>
