...
function nav(lang) {
  ...
  return `<nav class="lab-nav"><a class="official-brand" href="/${lang}/" aria-label="HolyLens home"><img class="lab-logo" src="/lab-static/static/holylens-logo.png" alt="HolyLens"></a><div class="official-links"><a href="/${lang}/">${zh ? "首页" : "Home"}</a><a href="/${lang}/#about">${zh ? "关于我们" : "About Us"}</a><a href="/${lang}/product/">${zh ? "产品" : "Product"}</a><a class="active" href="/${lang}/lab/">${zh ? "实验室" : "Lab"}</a><a href="/${lang}/#solution">${zh ? "解决方案" : "Solution"}</a><a href="/${lang}/#contact">${zh ? "联系我们" : "Contact"}</a></div><a class="official-language desktop-language" href="/${other}/lab/">${zh ? "EN" : "CN"} ↗</a><div class="official-mobile-links"><a href="/${lang}/#contact">${zh ? "联系我们" : "Contact"}</a><a class="official-language" href="/${other}/lab/">${zh ? "EN" : "CN"} ↗</a></div></nav>`;
}
